...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-rose-100 to-purple-100 flex flex-col items-center justify-center p-4 overflow-hidden">
      ...
      >
        <motion.div className="bg-black bg-opacity-80 backdrop-blur-sm rounded-3xl shadow-xl shadow-rose-100 p-8 border-2 border-rose-200"
          initial={{ scale: 0.9 }}
          animate={{ scale: 1 }}>
      ...
      <audio ref={audioRef} src="/lukachupi.mp3" preload="auto" loop />
